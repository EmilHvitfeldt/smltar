...
In R, text is typically represented as a character vector, similar to strings in other languages. If we look at the first paragraph of *The Fir Tree*, we find the text of the story is in multiple character vectors, which themselves are a series of letters, spaces, and punctuation.
...
These vectors don't contain any metadata or information to tell us which characters are words and which aren't. This is where the process of tokenization comes in.
