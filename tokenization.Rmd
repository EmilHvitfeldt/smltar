...
splitting by white-space is easy since we can use character classes \@ref(tab:characterclasses).
...
https://stackoverflow.com/questions/31003084/r-ngram-extraction-with-regex
