...
```{r ngramrmse, dependson="ngramrs", fig.cap="Comparing model performance for predicting the year of Supreme Court opinions with three different degrees of n-grams"}
list(`1` = unigram_rs,
     `1 and 2` = bigram_rs,
