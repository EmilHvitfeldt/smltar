...
```{r scotusfinalpredvis, dependson="finalscotusrs", opts.label = "fig.large", fig.cap="Predicted and true years from a linear SVM regression model with bigrams and unigrams"}
final_fitted %>%
  collect_predictions() %>%
