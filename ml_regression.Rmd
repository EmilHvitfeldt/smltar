...
- SVM
- Naive Bayes (used in classification chapter -- probaby not)
- knn
...
In this section, we are tokenizing via the [spaCy](https://spacy.io/) library as made available through the spacyr R package [@Benoit19].
