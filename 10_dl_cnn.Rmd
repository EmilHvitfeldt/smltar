...
knitr::include_graphics("diagram-files/cnn-architecture.pdf")
```
...
knitr::include_graphics("diagram-files/cnn-kernel-size.pdf")
```
...
```{r, results='hide', cache=FALSE, message=FALSE}
library(tfruns)
runs <- tuning_run(
  file = "cnn-spec.R",
  runs_dir = "_tuning",
