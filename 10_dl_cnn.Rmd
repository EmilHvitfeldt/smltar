...
```{block, type = "rmdnote"}
The **lime** package is not just limited to explaining CNNs. **lime** can be used with any of the models we have used in this book, even the ones trained with **parsnip**.
```
