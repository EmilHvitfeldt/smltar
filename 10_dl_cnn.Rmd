...
```{r limeplottextexplanations, echo=FALSE, fig.cap="Feature highlighting of words for two examples explained by a CNN model."}
...
htmltools::tagList(
  plot_text_explanations(explanation),
  htmltools::tags$style(all_styles)
)
```
...
```{r robustlimeplottextexplanations, echo=FALSE, fig.cap="Feature highlighting of words in two examples explained by a CNN model."}
htmltools::tagList(
  plot_text_explanations(explanation),
  htmltools::tags$style(all_styles)
)
