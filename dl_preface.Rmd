...
- Chapter \@ref(dllstm) continues by walking through how to train and evaluate a long short-term memory (LSTM) network. LSTMs are among the most common architectures used for text data because they model text as a long sequence of words or characters.
- Chapter \@ref(dlcnn) wraps up our treatment of deep learning for text with convolutional neural networks (CNN), another common architecture for text data because they detect and model specific local patterns.
