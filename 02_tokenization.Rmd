...
```{r tokenizationdiag, echo= FALSE, fig.cap="A black box representation of a tokenizer. The text has been lowercased and punctuation has been removed before the text is split.", out.width="90%"}
