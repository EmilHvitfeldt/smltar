...
tibble::tribble(
  ...
  knitr::kable(caption = "All meta characters", booktabs = TRUE)
```
...
tibble::tribble(
  ...
  knitr::kable(caption = "All character classes", booktabs = TRUE)
```
...
tibble::tribble(
  ...
  knitr::kable(caption = "Regular expression quantifiers", booktabs = TRUE)
```
...
tibble::tribble(
  ...
  knitr::kable(caption = "Lazy quantifiers", booktabs = TRUE)
```
