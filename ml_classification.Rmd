...
The tokenization and stop word removal will commence like normal, however, this time will we include trigrams, bigrams and unigrams in the model.
...
```{block, type = "rmdnote"}
This dataset has much more than 50 of the most common 2000 tokens. It is still a good practice to specify to be safe. 50 is also an arbitrary choice and needs to be picked depending on your preferences on the robustness of your model.
```
