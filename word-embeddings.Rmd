...
```{block, type = "rmdtip"}
How small is too small? It is hard to make definite statements because being able to determind useful word embeddings depends on the semantic and pragmatic details of *how* words are used in any given dataset. It may be unreasonable to expect good results with datasets smaller than a few hundred thousand documents, however.
```
