...
The **tidymodels** framework is a collection of R packages for modeling and machine learning using tidyverse principles. These packages facilitate preprocessing, modeling, and evaluation.
```
