...
```{r dense_model_compiled, dependson="dense_model", eval=TRUE}
dense_model %>% compile(
  optimizer = "rmsprop",
...
```{r dense_model_history, dependson="dense_model_compiled", eval=TRUE}
...
```{r dense_model_history_plot, dependson="dense_model_history", fig.cap="Training and validation metrics for dense network", eval=TRUE}
plot(history)
```
...
```{r dense_model_evaluate, dependson="dense_model_compiled", eval=TRUE}
dense_model %>%
  evaluate(
