...
```{r dense_model_compiled, dependson="dense_model"}
dense_model %>% compile(
  optimizer = "rmsprop",
...
```{r dense_model_history, dependson="dense_model_compiled"}
...
```{r dense_model_history_plot, dependson="dense_model_history", fig.cap="Training and validation metrics for dense network"}
plot(dense_history)
```
...
```{r dense_model_evaluate, dependson="dense_model_compiled"}
dense_model %>%
  evaluate(
