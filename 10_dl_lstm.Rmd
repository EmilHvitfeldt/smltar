...
```{block, type = "rmdnote"}
A good loss function for regression is mean squared error, `"mse"`.
```
...
We have been able to incrementally improve our model by adding to the structure and making good choices about preprocessing. Notice that this final model still does not perform as well as the best models of Chapter \@ref(dldnn). This is likely because tktk
