...
Compared to the documents we built deep learning models for in Chapter \@ref(dlclassification), these press releases are long, with a median character count of `r median(nchar(doj_press$contents), na.rm = TRUE)` for the `contents` of the press releases. We can use deep learning models to model these longer sequences.
