...
Text data is important for many domains, from healthcare to marketing to the digital humanities, but specialized approaches are necessary to create features (predictors) for machine learning from language. Natural language that we as speakers and/or writers use must be dramatically transformed into a machine-readable, numeric representation ready for computation. In this book, we explore typical text preprocessing steps from the ground up, and consider the effects of these steps. We also show how to conveniently use the [textrecipes](https://textrecipes.tidymodels.org/) R package [@textrecipes] to prepare text data within a modeling pipeline.
...
We would like to thank David Robinson for his collaboration on the tidytext package, Max Kuhn and Davis Vaughan for their investment in the tidymodels packages, the anonymous technical reviewers for their substantive and insightful feedback, and Desirée De Leon for the site design for this online work.
