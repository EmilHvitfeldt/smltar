...
We would like to thank David Robinson for his collaboration on the [tidytext](https://github.com/juliasilge/tidytext) package, Max Kuhn and Davis Vaughan for their investment in the [tidymodels](https://github.com/tidymodels/) packages, ..., and Desirée De Leon for the site design for this online work.
