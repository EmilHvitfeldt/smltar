...
The end of this book contains a software bibliography with descriptions of the software and packages being used; please refer to it for details on all software. Each chapter or section will start by loading the packages used there.

## Data {-}

throughout the book we will be giving examples using a selection of datasets. A description of the datasets can be found in the [data](#appendixdata) appendix.
