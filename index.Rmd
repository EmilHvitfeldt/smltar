...
We would like to thank Max Kuhn and Davis Vaughan for their investment in the tidymodels packages, David Robinson for his collaboration on the tidytext package, and Desirée De Leon for the site design for this online work. We would also like to thank Carol Haney, Kasia Kulma, David Mimno, Kanishka Misra, and an additional anonymous technical reviewer for their detailed, insightful feedback that substantively improved this book.
...
cat("This book was written in the open, and multiple people contributed via pull requests or issues. Special thanks goes to the ", nrow(contributors), " people who contributed via GitHub pull requests (in alphabetical order by username): ", sep = "")
